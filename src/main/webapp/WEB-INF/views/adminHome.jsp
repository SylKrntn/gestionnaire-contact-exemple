...
<html>
	...
	<body>
		...
		<p><a class="btn green-btn" href="${pageContext.request.contextPath}/defaut/contacts">Espace Defaut</a></p>
		
		<p>
			<a class="btn blue-btn" href="${pageContext.request.contextPath}/admin/users">Administrer les utilisateurs</a><br />
